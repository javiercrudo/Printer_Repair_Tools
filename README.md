...
![Imagen gral programa](https://github.com/user-attachments/assets/4d6894b9-06c9-4122-9ea7-58c0969cb97c)

________________________________________
🔧 Operaciones Básicas
Para un control manual detallado, dispone de tres funciones básicas:
4.	Detener Spooler: Apaga el motor de impresión de Windows. Útil si el sistema está bloqueado.
5.	Limpiar Archivos Temporales: Borra la memoria caché de las impresoras (identifica archivos .SPL y .SHD que traban la salida).
6.	Iniciar Spooler: Vuelve a encender el sistema de impresión.
________________________________________
...
<img width="440" height="243" alt="Funciones Pro" src="https://github.com/user-attachments/assets/f8dc6187-2484-4128-917c-8904ce50aab4" />
...
<img width="404" height="389" alt="Ayuda" src="https://github.com/user-attachments/assets/99db3141-6bec-47b0-8bc7-f196af1c9c2e" />

________________________________________
*© 2026 - Printer Tool – Solutions Dev*
